...
function confettiPoppen() {
  const start = () => {
    setTimeout(function () {
      confetti.start();
    }, 2); // 1000 is time that after 1 second start the confetti ( 1000 = 1 sec)
  };
...
document
  ...
  .addEventListener("click", showKunstwerk);
