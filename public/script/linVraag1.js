...
//zodat je de form niet submit als je op + of - klikt

const preventDefaultAction = (event) => {
  event.preventDefault();
};

document.querySelector('.minus').addEventListener('click', preventDefaultAction);
document.querySelector('.plus').addEventListener('click', preventDefaultAction);