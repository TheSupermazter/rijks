...
function updateButtonPosition() {
  ...
  // Set button position to the middle of the image
  button.style.top = imageRect.top + (imageHeight / 2) + 'px';
}

// Update button position initially and on image change
updateButtonPosition();
// If you're changing the image dynamically, call updateButtonPosition() after changing the image
